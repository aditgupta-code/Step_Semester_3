...
public class bankvalid {
    static String normalizeReference(String raw) {
        ...
        String bankCode = trimmed.substring(0, 3).toUpperCase();//trimmed is used to remove leading and trailing spaces.
        String rest = trimmed.substring(3);//it starts from index 3 to the end of the string, which is the remaining part of the reference after the bank code.
